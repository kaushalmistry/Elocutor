...
root1.iconbitmap(r"E:\Project\Elocutor\Application\Images\wheelchair_person.ico")
...
if Selection_Method != -1:
    ...
    root = tk.Tk()
    root.title("Elocutor")
    root.iconbitmap(r"E:\Project\Elocutor\Application\Images\wheelchair_person.ico")
    root.config(bg='gray')
    ...
    train_data_for_next_word = 'E:\\Project\\Elocutor\\Application\\Files\\friends_data.txt'
